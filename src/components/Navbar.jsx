                ...
                <div className='relative h-full'>
                  <div className='flex flex-col justify-end items-start h-full text-white text-left'>
                    <p className='my-5 font-normal text-base leading-tight tracking-wider' style={{ backdropFilter: 'none' }}>
                      <span className='font-heading2 font-bold text-base leading-tight tracking-wider'>00</span> HOME
                    </p>
                    <p className='my-5 font-normal text-base leading-tight tracking-wider' style={{ backdropFilter: 'none' }}>
                      <span className='font-heading2 font-bold text-base leading-tight tracking-wider'>01</span> DESTINATION
                    </p>
                    <p className='my-5 font-normal text-base leading-tight tracking-wider' style={{ backdropFilter: 'none' }}>
                      <span className='font-heading2 font-bold text-base leading-tight tracking-wider'>02</span> CREW
                    </p>
                    <p className='my-5 font-normal text-base leading-tight tracking-wider' style={{ backdropFilter: 'none' }}>
                      <span className='font-heading2 font-bold text-base leading-tight tracking-wider'>03</span> TECHNOLOGY
                    </p>
                  </div>
                </div>
              </div>
