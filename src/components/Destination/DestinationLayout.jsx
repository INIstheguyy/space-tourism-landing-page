    ...
    return ( 
        ...
        <div>
            ...
            <div className=" text-color3 my-3 text-center lg:text-left">
                ...
                <p className=" py-2 font-normal font-sans
                 text-color2  text-base md:text-[16px] md:px-[60px] lg:px-0 leading-6  lg:text-justify  md:tracking-widest ">{description}</p>
                <hr className=" my-5" />
